...
<h2 style="text-align:center;"> Order Form </h2>
        ...
        <form action="reply.html" method="post" onSubmit="return validate(this);"  id="submitform" >
            ...
            <div id="data">
                ...
                <img class="cardType" src="pages/visa.png" alt="visa" />
                <input type="radio" name="myRadio"   onchange="validate()"/><br>
                <img class="cardType" src="pages/mastercard.png" alt="mastercard" />
                <input type="radio" name="myRadio"  onchange="validate()"/><br>
                <img class="cardType" src="pages/american_express.jpg" alt="amercan_express"/>
                <input type="radio" name="myRadio"  onchange="validate()"/><br>
